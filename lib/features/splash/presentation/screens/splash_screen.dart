...
import 'package:jahiz/features/splash/presentation/cubit/splash_cubit.dart';
...
class _SplashScreenState extends State<SplashScreen>
  ...
  void initState() {
    ...
    _splashCubit.resolveDestination();
  }

  Widget _destinationScreen(StartupDestination destination) {
    switch (destination) {
      case StartupDestination.onboarding:
        return const OnboardingScreen();
      case StartupDestination.auth:
        return const AuthScreen();
      case StartupDestination.emailVerification:
        return const EmailVerificationScreen();
      case StartupDestination.home:
        return const HomeScrean();
      case StartupDestination.profileOnboarding:
        return const ProfileOnboardingScreen();
    }
  }

  Future<void> _goNext(StartupDestination destination) async {
    if (_hasNavigated) {
      return;
    }
    _hasNavigated = true;
    ...
    Navigator.pushReplacement(
      context,
      CupertinoPageRoute(builder: (_) => _destinationScreen(destination)),
    );
  }
